...
-- editTime     datetime     default CURRENT_TIMESTAMP not null comment '编辑时间',
    alter table user
    add column editTime datetime default CURRENT_TIMESTAMP not null comment '编辑时间' after userRole;
-- 题库表
...
alter table question_bank_question
    add column questionOrder int  default 0  not null comment '题目顺序（题号）' after questionId;
